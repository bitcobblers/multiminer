...
export const AllChains: Chain[] = [
  ...
  { name: 'ALGO', description: 'Algorand', token_format: '^[A-Z0-9]{58}$' },
  ...
  { name: 'DASH', description: 'Dash', token_format: '^[X7][0-9A-Za-z]{33}$' },
  ...
  { name: 'NANO', description: 'Nano', token_format: '^(xrb_|nano_)[1-9a-z]{60}$' },
  { name: 'QTUM', description: 'Qtum', token_format: '^[QM]{A-Za-z0-9}{33}$' },
  { name: 'RVN', description: 'Ravencoin', token_format: '^[Rr][A-Za-z0-9]{33,34}$' },
  ...
  { name: 'XTZ', description: 'Tezos', token_format: '^tz(123}|KT1)[a-zA-Z0-9]{33}$' },
